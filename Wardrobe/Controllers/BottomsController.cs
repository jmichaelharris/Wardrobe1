...
namespace Wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,Photo,Type,Color,Occasion,Season")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,Photo,Type,Color,Occasion,Season")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
