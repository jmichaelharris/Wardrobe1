...
namespace Wardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        {
            var shoes = db.Shoes.Include(s => s.Bottom).Include(s => s.Top);
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,Photo,Type,Color,Occasion,Season,TopID,BottomID")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,Photo,Type,Color,Occasion,Season,TopID,BottomID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
